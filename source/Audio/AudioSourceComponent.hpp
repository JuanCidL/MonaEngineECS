...
namespace Mona {
	...
	public:
		...
		*/
		...
		/*
		* Ajusta la instancia de AudioClip de esta fuente de audio. Tambien detiene la reproducci�n del
		* clip anterior.
		*/
		...
		* de que la fuente ya se encontraba reproduciendo este clip la reproducci�n vuelve a empezar del comienzo.
		*/
		void Play() noexcept;

		/*
		* Detiene completamente la reproduccin de audio de esta fuente. La proxima vez que se llame a Play, la reproducci�n
		* comenzara desde el principio del clip de audio.
		*/
		void Stop() noexcept;

		/*
		* Detiene la reproducci�n de audio de esta fuente. La proxima vez que se llame a Play la reproducci�n sera retomada
		...
		*/
		...
		/*
		* Retorna el radio de alcance de esta fuente de audio. Para fuentes 3D a mayor radio de alcance mas lento es el decaimiento del volumen en funci�n
		...
		*/
		...
		/*
		* Retorna verdadero si el audio clip reproducido por esta fuente esta en repetici�n.
		*/
